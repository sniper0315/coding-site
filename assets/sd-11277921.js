...
window.surveyData = {
    ...
    logo_text: "Qualify for a free VPN Trial",
    alert: {
     ...
     main: {
        type: "question",
        text: "Do you use your computer over 2 hours a day?",
        options: [
            { type: "button", text: "Yes", audience_id: [60623, 61427], action: { goto: "step2" } },{ type: "button", text: "No", audience_id: [60623, 61427], action: { goto: "step2" } }
        ],
    },
    step1: {
        type: "question",
        text: "Do you want a safe web browsing experience?",
        options: [
    ...
    step2: {
        type: "question",
        text: "Do you want privacy online? ",
        options: [
    ...
    step3: {
        type: "question",
        text: "Do you want your data collected by Facebook and other sites?",
        options: [
    ...
    step4: {
        type: "question",
        text: "Claim a free VPN trial by clicking Yes below",
        options: [
